...
public class Tiket {
    public static void pesanJumlahTiket(int jumlahTiket) {
        ...
        // To Do : Assertion untuk memastikan jumlah pemesanan tidak melebihi tiket yang
        // tersedia
    ...
    public static void isEWallet(int EWallet) {
        ...
        if (EWallet < 1 || EWallet > 4) {
            throw new IllegalArgumentException("Index e-wallet yang dipilih tidak valid");
        }
        // To Do : Assertion untuk memastikan e-wallet yang dipilih valid
        assert (EWallet >= 1 && EWallet <= 4) : "Index e-wallet yang dipilih tidak valid";
