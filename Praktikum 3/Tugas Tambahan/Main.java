    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (pilihanMenu == 1) {
                ...
                // TO DO 5: Tampilkan pesan bahwa menu tidak valid dan menghentikan eksekusi
                // program
                throw new MenuTidakTersediaException("Menu tidak valid");
            }

            // TO DO 6: Periksa apakah menu yang dipilih tidak null, jika null, seharusnya
            // menimbulkan (throw) MenuTidakTersediaException
            if (menu == null) {
                throw new MenuTidakTersediaException("Menu tidak valid");
            }

            // TO DO 7: Seharusnya menimbulkan (throw) JumlahPesananMelebihiStokException
            // jika jumlah pesanan melebihi stok yang tersedia
